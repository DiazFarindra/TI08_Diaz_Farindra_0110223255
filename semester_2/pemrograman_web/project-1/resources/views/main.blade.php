    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      ...
      -->
        <header class="header header-light header-topbar" id="navbar-spy">
            ...
            <div class="top-bar">
                ...
                <div class="block-right">
                    ...
                    <div class="module module-language">
                        <div class="selected"><img src="{{ asset('assets/images/module-language/en.png') }}" alt="alt" /><span>english</span><i class="fas fa-chevron-down"></i></div>
                        <div class="lang-list">
                            <ul>
                                <li> <img src="{{ asset('assets/images/module-language/en.png') }}" alt="alt" /><a href="#">english</a></li>
                                <li> <img src="{{ asset('assets/images/module-language/ar.png') }}" alt="alt" /><a href="#">arabic</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <!-- End .top-bar-->
            <nav class="navbar navbar-expand-xl navbar-sticky" id="primary-menu"><a class="navbar-brand" href="index.html"><img class="logo logo-dark" src="{{ asset('assets/images/logo/logo-dark.svg') }}" alt="Medisch Logo" /><img class="logo logo-mobile" src="{{ asset('assets/images/logo/logo-mobile.svg') }}" alt="Medisch Logo" /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    <div class="module-holder">
                        ...
                        <div class="module-contact">
                            ...
                            <a class="btn btn--primary btn-line btn-line-after" href="{{ route('register') }}">
                                <span>Register</span>
                                <span class="line">
                                    <span></span>
                                </span>
      ...
      -->
        <section class="features-bar" id="featuresBar-1">
            <div class="bg-section"> <img src="{{ asset('assets/images/background/pattern-2.jpg') }}" alt="background" /></div>
            <div class="container">
                    ...
                    <div class="col-12 col-lg-3">
                        ...
                        <div class="feature-panel feature-location">
                            <div class="feature-content"><i class="flaticon-042-clinic"></i>
                                ...
                                <div class="map-img"> <a href="contact.html"></a><img src="{{ asset('assets/images/background/map.jpg') }}" alt="map" /></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="about-img"><img class="img-fluid" src="{{ asset('assets/images/about/5.jpg') }}" alt="about Image" /><a class="popup-video btn-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i><span>watch our presentation!</span></a></div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class=" col-12 col-md-6 col-lg-4">
                        <div class="department-panel" data-hover="">
                            <div class="department-panel-holder">
                                <div class="department-img"><a href="page-departments.html"></a><img src="{{ asset('assets/images/departments/1.jpg') }}" alt="department img" /></div>
                    ...
                    <div class=" col-12 col-md-6 col-lg-4">
                        <div class="department-panel" data-hover="">
                            <div class="department-panel-holder">
                                <div class="department-img"><a href="page-departments.html"></a><img src="{{ asset('assets/images/departments/2.jpg') }}" alt="department img" /></div>
                                <div class="department-content">
                                    <div class="department-title">
                    ...
                    <div class=" col-12 col-md-6 col-lg-4">
                        <div class="department-panel" data-hover="">
                            <div class="department-panel-holder">
                                <div class="department-img"><a href="page-departments.html"></a><img src="{{ asset('assets/images/departments/3.jpg') }}" alt="department img" /></div>
                                <div class="department-content">
                                    <div class="department-title">
                        ...
                        <div class="col-12 col-lg-5 offset-lg-2">
                            <div class="doctor-action"><a class="btn btn--secondary btn-line btn-line-after" href="page-appointments.html"> <span>make appointment</span><span class="line"> <span></span></span></a>
                                <div class="doctor-info">
                                    <div class="doctor-img"> <img src="{{ asset('assets/images/testimonial/5.jpg') }}" alt="image" /></div>
                        ...
                        <div class="col-12 col-lg-6 offset-lg-1">
                            ...
                            <div class="signature-block"><a class="btn btn--primary btn--inversed btn-line btn-line-after" href="#"><span>our core values</span><span class="line"> <span></span></span></a>
                                <div class="signature-body">
                                    <h6>john winston</h6>
                                    <p>pediatrician</p><img class="signature-img" src="{{ asset('assets/images/signature/2.png') }}" alt="signature" />
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      -->
        <section class="testimonial testimonial-1 testimonial-2" id="testimonial-2">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-5">
                        <div class="clients-img"> <img src="{{ asset('assets/images/testimonial/image.png') }}" alt="image" /></div>
                    </div>
                    <div class="col-12 col-lg-6 offset-lg-1">
                                ...
                                <div class="testimonial-body">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="testimonial-thumb">
                                            <div class="thumb-img"> <img src="{{ asset('assets/images/testimonial/1.jpg') }}" alt="Testimonial Author" /><i class="icon-Quote-Icon"></i></div>
                            ...
                            <div class="testimonial-panel testimonial-panel-2">
                                <div class="testimonial-body">
                                    <div class="testimonial-content">
                                        ...
                                        <p>Their doctors include highly qualified practitioners who come from a range of backgrounds &amp; bring with them a diversity of skills and special interests. They also registered nurses available to triage any urgent matters, and the administration and staff all have exceptional skills!!</p>
                                        <div class="testimonial-thumb">
                                            <div class="thumb-img"> <img src="{{ asset('assets/images/testimonial/2.jpg') }}" alt="Testimonial Author" /><i class="icon-Quote-Icon"></i></div>
                                            <div class="thumb-body">
                                                <h6>john peter</h6>
                                                <p>optima inc</p>
                                            </div>
                            ...
                            <div class="testimonial-panel testimonial-panel-2">
                                <div class="testimonial-body">
                                    <div class="testimonial-content">
                                        ...
                                        <p>Their doctors include highly qualified practitioners who come from a range of backgrounds &amp; bring with them a diversity of skills and special interests. They also registered nurses available to triage any urgent matters, and the administration and staff all have exceptional skills!!</p>
                                        <div class="testimonial-thumb">
                                            <div class="thumb-img"> <img src="{{ asset('assets/images/testimonial/3.jpg') }}" alt="Testimonial Author" /><i class="icon-Quote-Icon"></i></div>
                                            <div class="thumb-body">
                                                <h6>sony blake</h6>
                                                <p>koira ind</p>
                                            </div>
                    ...
                    <div class="col-12">
                        <div class="carousel owl-carousel carousel-navs" data-slide="3" data-slide-rs="2" data-autoplay="true" data-nav="true" data-dots="false" data-space="30" data-loop="true" data-speed="3000">
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/1.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                            ...
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/2.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                                        <div class="team-content-holder">
                                            <div class="team-content">
                                                <div class="team-title">
                            ...
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/3.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                                        <div class="team-content-holder">
                                            <div class="team-content">
                                                <div class="team-title">
                            ...
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/4.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                                        <div class="team-content-holder">
                                            <div class="team-content">
                                                <div class="team-title">
                            ...
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/5.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                                        <div class="team-content-holder">
                                            <div class="team-content">
                                                <div class="team-title">
                            ...
                            <div>
                                <div class="team-member" data-hover="">
                                    <div class="team-member-holder">
                                        <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="{{ asset('assets/images/team/grid/6.jpg') }}" alt="team member" /></div>
                                        <!-- End .team-img-->
                                        <div class="team-content-holder">
                                            <div class="team-content">
                                                <div class="team-title">
                    ...
                    <div class="heading heading-light heading-11">
                        ...
                        <div class="img-hotspot">
                            <div class="img-hotspot-wrap">
                                <div class="img-hotspot-bg"> <img src="{{ asset('assets/images/background/world-map.png') }}" alt="" /></div>
                                <div class="img-hotspot-pointers">
                                    <div class="img-hotspot-pointer" data-spot-x="15%" data-spot-y="29%"><img src="{{ asset('assets/images/background/map-pointer.png') }}" alt="pointer" />
                                        <div class="info right" data-info-x="18px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                                    </div>
                                    <div class="img-hotspot-pointer" data-spot-x="48%" data-spot-y="48%"><img src="{{ asset('assets/images/background/map-pointer.png') }}" alt="pointer" />
                                        <div class="info left" data-info-x="-160px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                                    </div>
                                    <div class="img-hotspot-pointer" data-spot-x="68%" data-spot-y="23%"><img src="{{ asset('assets/images/background/map-pointer.png') }}" alt="pointer" />
                                        <div class="info left" data-info-x="-160px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/1.jpg') }}" alt="6 tips to protect your mental health when sick" /></a>
                            </div>
                            <!-- End .entry-img-->
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/2.jpg') }}" alt="Unsure About Wearing a Face Mask? How and Why" /></a>
                            </div>
                            <!-- End .entry-img-->
                            <div class="entry-content">
                                <div class="entry-meta">
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/3.jpg') }}" alt="Tips for Eating Healthy When Working From Home" /></a>
                            </div>
                            <!-- End .entry-img-->
                            <div class="entry-content">
                                <div class="entry-meta">
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/4.jpg') }}" alt="Why Coronavirus Cases Among Adults Is Bad News" /></a>
                            </div>
                            <!-- End .entry-img-->
                            <div class="entry-content">
                                <div class="entry-meta">
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/5.jpg') }}" alt="Why Do People Get Kidney Stones in the Summer?" /></a>
                            </div>
                            <!-- End .entry-img-->
                            <div class="entry-content">
                                <div class="entry-meta">
                    ...
                    <div>
                        <div class="blog-entry" data-hover="">
                            <div class="entry-img">
                                ...
                                <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="{{ asset('assets/images/blog/grid/6.jpg') }}" alt="Do Any Drugs Really Work to Treat Coronavirus?" /></a>
                            </div>
                            <!-- End .entry-img-->
                            <div class="entry-content">
                                <div class="entry-meta">
