    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          {/* Brand */}
          <div>
            <h3 className="mb-4 text-xl font-bold text-white">TI-08 Dev</h3>
            <p className="text-sm">
              Platform pembelajaran web development dengan teknologi modern.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/team" className="hover:text-indigo-400 transition">
                  Tim
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 hover:bg-indigo-600 transition"
                title="GitHub"
              >
                <svg
                  className="h-5 w-5"
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-center text-sm md:flex-row">
          <p>&copy; 2026 TI-08 Dev. All rights reserved.</p>
