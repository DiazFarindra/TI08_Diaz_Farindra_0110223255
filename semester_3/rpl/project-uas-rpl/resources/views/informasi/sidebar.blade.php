  ...
  <dh-component>
    <div class="flex flex-no-wrap">
        ...
        <div style="min-height: 110vh" class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                <div class="h-16 w-full flex items-center">
                  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-bold tracking-tight text-slate-200 mr-4"><a href="profil">Management Laporan</a></h1>
                  </div>
                </div>
                <ul class="mt-6">
                    ...
                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <span class="text-sm ml-2">Edit Profil</span>
                        </a>
                    </li>
                </ul>
            </div>
