...
<body>
    ...
    <div class="card bg-white shadow-md w-full">
        ...
        <div class="card-header bg-blue-500 text-white p-4 flex justify-between items-center">
            <h3 class="card-title text-lg font-semibold">Informasi Mahasiswa dan Dosen</h3>
        ...
        <div class="card-body p-6">
            <a href="{{ route('informasi.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2  rounded-lg inline-flex items-center">
                    ...
                    <table class="w-full border-collapse border border-gray-200 shadow-sm rounded-md">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Pesan</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Status</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Keterangan</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{ $data->pesan }}</td>
                                ...
                                <td class="border border-gray-300 px-4 py-2 flex justify-center space-x-2">
                                    <a href="{{ route('informasi.edit', $data->id) }}" class="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded-md flex items-center">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{{ route('informasi.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
            ...
            <!-- Tabel Dosen -->
            <div class="mt-8">
                <h2 class="text-2xl font-semibold text-gray-700">Data Dosen</h2>
                <a href="{{ route('informasi.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 mt-2 mb-4 rounded-lg inline-flex items-center">
                    <i class="fas fa-plus mr-2"></i>Tambah Data
                </a>
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse border border-gray-200 shadow-sm rounded-md">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">No</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Dosen</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Pesan</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Status</th>
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">Keterangan</th>
                                <th class="border border-gray-300 px-4 py-2 text-center font-semibold text-gray-600">Aksi</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="border border-gray-300 px-4 py-2">{{ $loop->iteration }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $data->dosen->nama ?? '-' }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $data->pesan }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $data->status }}</td>
                                <td class="border border-gray-300 px-4 py-2">Dosen</td>
                                <td class="border border-gray-300 px-4 py-2 flex justify-center space-x-2">
                                    <a href="{{ route('informasi.edit', $data->id) }}" class="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded-md flex items-center">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
