...
<body class="bg-gray-100">
    ...
    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="post" enctype="multipart/form-data" class="w-full max-w-4xl mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg">
        @csrf
        @method('PATCH')
