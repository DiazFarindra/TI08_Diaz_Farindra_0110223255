    ...
    <div class="flex flex-col w-full gap-6 ">
        ...
        <div class="card bg-white shadow-md w-full">
            ...
            <div class="card-header bg-blue-500 text-white p-4 flex justify-between items-center">
                <h3 class="card-title text-lg font-semibold">Informasi Mahasiswa</h3>
                    ...
                    <table class=" w-full border-collapse border border-gray-200 shadow-sm rounded-md ">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-600">
                                    Mahasiswa</th>
                        ...
                        <tbody>
                            @foreach ($mahasiswa as $mhs)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">{{ $mhs->nama ?? 'Tidak Diketahui' }}
                                    </td>
