    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            ...
            <div class="w-full h-full">
                            ...
                            <div class="px-8">
                                <div class="h-16 w-full flex items-center">
                                    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                                        <h1 class="text-3xl font-bold tracking-tight text-slate-200 mr-2"><a href="/profil">Admin</a></a></h1>
                                    </div>
                                </div>
                                <ul class="mt-6">
                                    ...
                                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                            ...
                                            <span class="text-sm ml-2"><a href="akun">Management Akun</a></span>
                                        </a>
                                    ...
                                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                            ...
                                            <span class="text-sm ml-2"><a href="informasi">Informasi Akun</a></span>
                                        </a>
                                    </li>
                                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                            ...
                                            <span class="text-sm ml-2"><a href="penjadwalan">Jadwal Bimbingan</a></span>
                                        </a>
                                    </li>
                                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                            ...
                                            <span class="text-sm ml-2"><a href="laporan">Laporan Mahasiswa</a></span>
                                        </a>
                                    ...
                                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                            ...
                                            <span class="text-sm ml-2">Pengaturan</span>
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="bg-white overflow-hidden shadow sm:rounded-lg dark:bg-gray-900">
                                                <div class="px-4 py-5 sm:p-6">
                                                    <dl>
                                                        ...
                                                        <dd class="mt-1 text-3xl leading-9 font-semibold text-indigo-600 dark:text-indigo-400">35
                                                        </dd>
                                                    </dl>
                                                </div>
                                            </div>
                ...
                <!-- Card Container -->
                <div class="bg-white w-80 p-6 rounded-xl shadow-md border border-gray-200">
                    <!-- Title -->
                    <h1 class="text-lg font-bold text-black mb-4">Notifikasi Terbaru</h1>

                    <!-- Notification Item 1 -->
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-black">Jadwal bimbingan baru ditambahkan</h2>
                    ...
                    <!-- Notification Item 2 -->
                    <div class="mb-4">
                        <h2 class="text-sm font-semibold text-black">Laporan perlu ditinjau</h2>
                    ...
                    <!-- Notification Item 3 -->
                    <div>
                        <h2 class="text-sm font-semibold text-black">Tugas mendekati tenggat</h2>
